package com.unir.tiendacompulago.shoppingservice.controller;

import com.unir.tiendacompulago.shoppingservice.entity.Invoice;
import com.unir.tiendacompulago.shoppingservice.service.InvoiceService;
...
public class InvoiceController {
    ...
    public ResponseEntity<Invoice> getInvoice(@PathVariable("numberInvoice") String id){
        log.info("Fetching Invoice with numberInvoice {}", id);
